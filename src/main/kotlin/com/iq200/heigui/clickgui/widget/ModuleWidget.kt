...
import com.iq200.heigui.clickgui.blend
...
class ModuleWidget(val module: Module) : HeiguiContainerWidget(0, 0, GuiTheme.ROW_WIDTH, GuiTheme.ROW_HEIGHT, Component.literal(module.name)) {
...
private class ModuleHeaderWidget(private val group: ModuleWidget, private val module: Module) : HeiguiWidget(
