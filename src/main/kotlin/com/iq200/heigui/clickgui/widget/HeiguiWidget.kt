...
abstract class HeiguiWidget(x: Int, y: Int, width: Int, height: Int, message: Component) : AbstractWidget(x, y, width, height, message) {
...
abstract class HeiguiContainerWidget(x: Int, y: Int, width: Int, height: Int, message: Component) : HeiguiWidget(x, y, width, height, message),
    ...
    override fun mouseClicked(event: MouseButtonEvent, doubleClick: Boolean): Boolean =
        super<ContainerEventHandler>.mouseClicked(event, doubleClick) ||
                super<HeiguiWidget>.mouseClicked(event, doubleClick)

    override fun mouseReleased(event: MouseButtonEvent): Boolean =
        super<ContainerEventHandler>.mouseReleased(event) || super<HeiguiWidget>.mouseReleased(event)

    override fun mouseDragged(event: MouseButtonEvent, dragX: Double, dragY: Double): Boolean =
        super<ContainerEventHandler>.mouseDragged(event, dragX, dragY) ||
                super<HeiguiWidget>.mouseDragged(event, dragX, dragY)
