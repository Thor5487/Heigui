...
import com.iq200.heigui.utils.Color.Companion.blue
import com.iq200.heigui.utils.Color.Companion.green
import com.iq200.heigui.utils.Color.Companion.red
...
object NVGRenderer {
    ...
    val defaultFont = Font("Default", mc.resourceManager.getResource(Identifier.parse("heigui:font.ttf")).get().open())
