...
import com.iq200.heigui.utils.skyblock.dungeon.tiles.RoomComponent
import com.iq200.heigui.utils.skyblock.dungeon.tiles.RoomData
...
object ScanUtils {
    ...
    val roomList: Set<RoomData> = JsonResourceLoader.loadJson("/assets/heigui/rooms.json", setOf())
